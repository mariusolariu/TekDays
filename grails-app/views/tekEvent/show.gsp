			...
			<ol class="property-list tekEvent">
				...
				<li class="fieldcontain">
					<span id="startDate-label" class="property-label"><g:message code="tekEvent.startDate.label" default="Start Date" /></span>
						...
						<span class="property-value" aria-labelledby="startDate-label"><g:formatDate format="ddMMMyyy HH:mm" date="${tekEventInstance?.startDate}" /></span>
				...
				<li class="fieldcontain">
					<span id="endDate-label" class="property-label"><g:message code="tekEvent.endDate.label" default="End Date" /></span>
						...
						<span class="property-value" aria-labelledby="endDate-label"><g:formatDate format="ddMMMyyy HH:mm" date="${tekEventInstance?.endDate}" /></span>
				...
				<li class="fieldcontain">
					<span id="sponsors-label" class="property-label"><g:message code="tekEvent.sponsors.label" default="Sponsors" /></span>
				...
				<g:if test="${tekEventInstance?.respondentsEmails}">
				<li class="fieldcontain">
					<span id="respondentsEmails-label" class="property-label"><g:message code="tekEvent.respondentsEmails.label" default="Respondents Emails" /></span>
					
						<span class="property-value" aria-labelledby="respondentsEmails-label"><g:fieldValue bean="${tekEventInstance}" field="respondentsEmails"/></span>
