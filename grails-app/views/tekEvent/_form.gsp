...
<div class="fieldcontain ${hasErrors(bean: tekEventInstance, field: 'respondentsEmails', 'error')} ">
	<label for="respondentsEmails">
		<g:message code="tekEvent.respondentsEmails.label" default="Respondents Emails" />
