	...
	<body>
		...
		<div id="show-tekUser" class="content scaffold-show" role="main">
			...
			<ol class="property-list tekUser">
				...
				<g:if test="${tekUserInstance?.firstName}">
				<li class="fieldcontain">
					<span id="firstName-label" class="property-label"><g:message code="tekUser.firstName.label" default="First Name" /></span>
					
						<span class="property-value" aria-labelledby="firstName-label"><g:fieldValue bean="${tekUserInstance}" field="firstName"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${tekUserInstance?.lastName}">
				<li class="fieldcontain">
					<span id="lastName-label" class="property-label"><g:message code="tekUser.lastName.label" default="Last Name" /></span>
					
						<span class="property-value" aria-labelledby="lastName-label"><g:fieldValue bean="${tekUserInstance}" field="lastName"/></span>
				...
				<li class="fieldcontain">
					<span id="username-label" class="property-label"><g:message code="tekUser.username.label" default="Username" /></span>
